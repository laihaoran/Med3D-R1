...
from LaMed.src.model.language_model.lamed_phi3 import LamedPhi3ForCausalLM
...
@dataclass
class DataArguments:
    data_root: str = field(default="./Data/bimcv-r", metadata={"help": "Root directory for all data."})

    # caption data
    cap_data_path: str = field(default="./Data/bimcv-r/combined.json", metadata={"help": "Path to caption data."})
...
def main():
    ...
    if tokenizer.unk_token is not None and tokenizer.pad_token is None:
        ...
        tokenizer.pad_token =  "<|eot_id|>" # for llama3
