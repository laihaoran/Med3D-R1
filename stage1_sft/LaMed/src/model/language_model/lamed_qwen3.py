...
class LamedConfig(Qwen3Config):
    model_type = "lamed_qwen3"

class LamedQwen3Model(LamedMetaModel, Qwen3Model):
    config_class = LamedConfig
    def __init__(self, config: LamedConfig):
        super(LamedQwen3Model, self).__init__(config)


class LamedQwen3ForCausalLM(LamedMetaForCausalLM, Qwen3ForCausalLM):
    config_class = LamedConfig
    ...
    def __init__(self, config: LamedConfig):
        ...
        self.model = LamedQwen3Model(config)
...
AutoConfig.register("lamed_qwen3", LamedConfig)
AutoModelForCausalLM.register(LamedConfig, LamedQwen3ForCausalLM)